...
This section will focus on rendering three-dimensional fractal shapes, specifically the Mandelbulb. Firstly, signed distance functions will be explained, followed by a very brief explanation of ray tracing. Finally, the application of the signed distance functions to ray tracing will be discussed.
...
\begin{figure} [ht]
	\centering
	\includegraphics[width=0.5\linewidth, frame]{Images/Quilez-Bottcher-Map-Image.jpg}
	\caption{The B\"{o}ttcher map generated for the Julia set (another two-dimensional complex fractal), from the website of Inigo Quilez \cite{quilez-distance}.}
...
Papers:
\begin{itemize}
	\item Ray Tracing Gems: High-Quality and Real-Time Rendering with DXR and Other APIs \cite{haines2019ray}.
	\item Ray Tracing Gems II \cite{marrs2021ray}.
	\item Procedural Rendering w/Ray Marching \cite{roblesprocedural}.
	\item Distance to Fractals \cite{quilez-distance}.
\end{itemize}
